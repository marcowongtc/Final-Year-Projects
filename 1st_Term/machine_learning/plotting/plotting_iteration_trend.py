...
for model in model_list:
    ...
    for chain_no in chain_no_list:
        ...
        for n_iteration in n_iteration_list:
            ...
            # Plot multiple lines
            if chain_no == 1:
                ax.plot(ID_list, imp_array[0:295], label = 'n = {}'.format(n_iteration)) #get 1-295
            if chain_no == 2:
                ax.plot(ID_list, imp_array[295:], label = 'n = {}'.format(n_iteration)) #get 295-590
        ...
        ax.set_title('{}-chain_{}-model n_iteration trend'.format(chain_no, model))
        ...
        plt.savefig('{}-chain_{}-model_n_iteration_{}_plot.png'.format(chain_no, model, n_iteration_list))
