...
all_ps_array = [10, 20, 50, 100, 200, 500, 1000, 2000, 5000, 10000]
TotPCNo = 5

mean_1ps, dev_1ps = cosine_analysis(one_ps_array, 10000, 1)
mean_01ps, dev_01ps = cosine_analysis(pointone_ps_array, 1000, 0.1)
...
cosine_mean_all_array = np.concatenate((mean_01ps[:,:3], mean_1ps), axis=1)
cosine_dev_all_array = np.concatenate((dev_01ps[:,:3], dev_1ps), axis=1)

print("all | mean \n {}\n".format(cosine_mean_all_array))
print("all | dev \n {}\n".format(cosine_dev_all_array))


np.save("cosine_mean_all.npy", cosine_mean_all_array)
np.save("cosine_dev_all.npy", cosine_dev_all_array)
