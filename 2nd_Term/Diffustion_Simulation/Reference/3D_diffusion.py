...
def diffusion_model(random_moves, **kwargs):
...
def example_nd_simulations():
    ...
    fig0 = pyplot.figure(figsize=(7.0, 7.0))
    plot0 = fig0.add_subplot(111, projection='3d')
    fig1 = pyplot.figure()
    ...
    plot_positions(positions, selection=numpy.arange(20), ax=plot0)
